                ...
                child: Container(
                  ...
                  child: Center(
                    child: Icon(Icons.favorite_rounded,
                        color: Colors.white.withOpacity(0.8 + glow * 0.2),
                        size: 36),
                  ),
                ),
              ),
      ...
      builder: (_, __) => Container(
        decoration: BoxDecoration(
          gradient: RadialGradient(
            ...
            colors: [
              const Color(0xFF1E1035).withOpacity(0.8),
  ...
  void paint(Canvas canvas, Size size) {
    for (final p in pts) {
      ...
      canvas.drawCircle(
        Offset(x, y), p[2],
        Paint()
          ..color = _colors[p[4].toInt()].withOpacity(p[3] * (0.4 + breathe * 0.6))
