...
class _PartnerMoodCard extends StatelessWidget {
  const _PartnerMoodCard({required this.mood});
  final Mood mood;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                mood.colors.first.withOpacity(0.12),
                mood.colors.last.withOpacity(0.07),
              ],
            ),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: mood.colors.first.withOpacity(0.25),
              width: 0.5,
            ),
          ),
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: mood.colors.first.withOpacity(0.15),
...
class _ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (final p in _particles) {
      ...
      final r = p[2] as double;
      final op = p[3] as double;
      final ci = (p[4] as double).toInt();
      ...
      canvas.drawCircle(
        ...
        r,
        Paint()
          ..color = color.withOpacity(op * (0.5 + breathe * 0.5))
