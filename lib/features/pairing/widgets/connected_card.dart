              ...
              child: Stack(
                ...
                children: [
                  ...
                  Icon(
                    ...
                    size: 28 + pulse * 6,
                    color: Colors.white.withOpacity(0.5 + pulse * 0.3),
                  ),
                ],
              ),
            )
            ...
            ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF34D399).withOpacity(0.07),
                    borderRadius: BorderRadius.circular(18),
                    border: Border.all(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          colors: [
            colors.first.withOpacity(0.4 + pulse * 0.2),
        ...
        boxShadow: [
          BoxShadow(
            color: colors.first.withOpacity(0.25 + pulse * 0.2),
