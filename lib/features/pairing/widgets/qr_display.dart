          ...
          children: [
            ...
            Text('YOUR PAIR CODE',
                style: TextStyle(
                  ...
                  color: Colors.white.withOpacity(0.35), letterSpacing: 2.5,
                )),
              ...
              children: widget.pairCode.split('-').asMap().entries.map((e) {
                return Row(children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFFC084FC)
                          .withOpacity(0.08 + glow * 0.06),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: const Color(0xFFC084FC)
                            .withOpacity(0.25 + glow * 0.15),
                        width: 0.5,
                      ),
                    ),
                    child: Text(e.value,
            ...
            Text('Share this code or QR with your partner',
                style: TextStyle(
                  ...
                  color: Colors.white.withOpacity(0.3), letterSpacing: 0.5,
                )),
          ],
        );
      },
